...
async function run() {
  try {
    ...
    docsToDeleteOne = await collection.find({ user: /alan/i }).toArray(); // Búsqueda insensible a mayúsculas
    console.log('Documentos que coinciden con deleteOne:', docsToDeleteOne);

    // **Eliminar un Solo Documento**
    // Ejemplo: eliminar un documento donde el campo 'Nombre' sea 'alan sin importar mayúsculas'
    deleteResultOne = await collection.deleteOne({ user: /alan/i });
