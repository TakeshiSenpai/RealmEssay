...
async function run() {
  try {
    ...
    const filter = { Nombre: 'Gokú Ramírez' }; // Criterio de búsqueda para encontrar el documento
    const updateDoc = {
      $set: {
        Email: 'goku.supersayajingodfase10@uabc.edu.mx', // Nuevo valor para el campo 'Email'
      },
    };
