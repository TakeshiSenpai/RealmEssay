...
INPUT_FILE = pathlib.Path('ia_response/input.json').resolve()
CRITERIA_FILE = pathlib.Path('ia_response/criteria.json').resolve()
INTERACTIONS_FILE = pathlib.Path('ia_response/user_interactions/interactions.json').resolve()
TTS_FILE = pathlib.Path('ia_response/cleanOutput.mp3').resolve()
...
# Función para ejecutar un modelo de IA con los datos de entrada proporcionados
